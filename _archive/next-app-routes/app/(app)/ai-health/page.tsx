    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Educational guidance with family member context, category filters,
          previous chats, and document attachments.
        </p>
      </div>
      <div className="grid gap-4 xl:grid-cols-[420px_1fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Requires server-side OPENAI_API_KEY. ChatGPT Free is not an app
              API backend.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Stored AI health conversations for this family.
            </CardDescription>
          </CardHeader>
