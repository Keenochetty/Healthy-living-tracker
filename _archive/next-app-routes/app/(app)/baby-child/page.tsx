...
export default async function BabyChildPage() {
  ...
  const children = data.members.filter((member) =>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Feeding, sleep, diapers, medicine, temperature, vaccinations, growth,
          milestones, and sickness logs.
        </p>
      </div>
      <Tabs defaultValue="activity">
        ...
        <TabsContent value="feeding">
          <Card className="max-w-2xl">
            <CardHeader>
              <CardTitle>Log child care entry</CardTitle>
              <CardDescription>
                Use categories for feeding, sleep, diaper, vaccination, growth,
                milestones, or sickness notes.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <HealthLogForm members={members} />
            </CardContent>
          </Card>
        </TabsContent>
