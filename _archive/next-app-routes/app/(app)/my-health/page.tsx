import {
  ActivityList,
  MedicineAlerts,
} from "@/components/dashboard/data-lists";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Track symptoms, medicine, vitals, doctors, documents, and trends.
        </p>
      </div>
      <QuickActions
        chats={data.aiChats}
      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="overview">
          <SummaryCards
            ...
            logs={data.healthLogs.length}
            medicines={data.medicineLogs.length}
        ...
        <TabsContent value="doctors">
          <div className="grid gap-4 xl:grid-cols-[1fr_380px]">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Add doctor visit</CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="trends">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Trend charts will summarize logged vitals, mood, pain, medicine,
                and visits as data grows.
              </CardDescription>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
              Add health logs to populate this section.
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
