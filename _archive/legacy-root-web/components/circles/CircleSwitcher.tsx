      ...
      <View style={styles.header}>
        <View style={styles.headerCopy}>
          ...
          <Text style={styles.subtitle}>
            Switch between household and care circles. Caregiver work stays in
            the Care tab.
          </Text>
        </View>
        {onManage ? (
      ...
      <View style={styles.circleRow}>
        {circles.map((circle) => {
          ...
          return (
            ...
            >
              <View
                style={[styles.circleIcon, selected && styles.selectedIcon]}
              >
                <AppIcon
                  color={
              ...
              <View style={styles.circleCopy}>
                ...
                <Text style={styles.circleMeta}>
                  {circleRoleLabels[circle.currentUserRole]}
                </Text>
              </View>
              {circle.source === "placeholder" ? (
