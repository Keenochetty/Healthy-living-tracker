  ...
  async function handleGrantCaregiverAccess() {
    ...
    try {
      ...
      setErrorMessage(
        error instanceof Error
          ? error.message
          : "Unable to grant caregiver access.",
      );
    } finally {
      ...
      {child && canEdit ? (
        <View style={styles.section}>
          ...
          {isSaving ? (
            ...
            <Button onPress={handleSave} title="Save child profile" />
          )}
        </View>
      ) : (
        <Text style={styles.muted}>
          Only parents/guardians with family permission can edit child profiles.
        </Text>
      )}
      ...
      {child && canEdit ? (
        <View style={styles.section}>
          ...
          <View style={styles.switchRow}>
            ...
            <Switch
              onValueChange={setCanViewCareInstructions}
              value={canViewCareInstructions}
            />
          </View>
          <View style={styles.switchRow}>
          ...
          <View style={styles.switchRow}>
            ...
            <Switch
              onValueChange={setCanUploadPhotos}
          ...
          <View style={styles.switchRow}>
            ...
            <Switch
              onValueChange={setCanUseEmergencyButton}
              value={canUseEmergencyButton}
            />
          </View>
          {isGrantingAccess ? (
            <ActivityIndicator />
            ...
            <Button
              onPress={handleGrantCaregiverAccess}
