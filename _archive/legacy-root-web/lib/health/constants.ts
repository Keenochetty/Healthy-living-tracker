...
export const privacyLevelLabels: Record<
  (typeof privacyLevels)[number],
  string
> = {
  private: "Private",
...
export const notificationUrgencyLabels: Record<
  (typeof notificationUrgencies)[number],
  string
> = {
...
export const notificationUrgencyClasses: Record<
  (typeof notificationUrgencies)[number],
  string
> = {
...
export const caregiverActivityLabels: Record<
  (typeof caregiverActivityTypes)[number],
  string
> = {
  feed: "Feed",
  nap: "Nap",
...
export const calendarEventTypeLabels: Record<
  (typeof calendarEventTypes)[number],
  string
> = {
...
export const trackingCategoryLabels: Record<
  (typeof trackingCategories)[number],
  string
> = {
  symptom: "Symptom",
  medicine: "Medicine",
