  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.details}>
        <Text>
          Allergies:{" "}
          {isCaregiverView ? "Approved allergies only" : "None added yet"}
        </Text>
        {!isCaregiverView ? <Text>Conditions: None added yet</Text> : null}
        <Text>
          Emergency contact:{" "}
          {isCaregiverView ? "Shown if approved" : "Not added yet"}
        </Text>
        <Text>Today schedule: No schedule added yet</Text>
        <Text>
          Caregiver access status:{" "}
          {isCaregiverView ? "Active approved access" : "Not configured"}
        </Text>
      </View>
