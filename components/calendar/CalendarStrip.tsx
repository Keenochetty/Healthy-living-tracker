...
function buildDays(selectedDate: Date, mode: CalendarViewMode) {
  ...
  start.setDate(
    selectedDate.getDate() - (mode === "week" ? selectedDate.getDay() : 3),
  );
  ...
  return (
    <View style={styles.container}>
      <View style={styles.selector}>
        ...
        >
          <Text
            style={[styles.modeText, mode === "week" && styles.modeTextActive]}
          >
            Week
          </Text>
        </Pressable>
        ...
        >
          <Text
            style={[styles.modeText, mode === "month" && styles.modeTextActive]}
          >
            Month
          </Text>
        </Pressable>
          ...
          return (
            ...
            >
              <Pressable
                ...
                style={({ pressed }) => [
                  styles.dayMenuButton,
                  pressed && styles.pressed,
                ]}
              >
                <AppIcon color={colors.text.muted} name="more" size={16} />
              </Pressable>
              <Text style={[styles.dayName, selected && styles.dayTextActive]}>
                {formatDayName(date)}
              </Text>
              <Text
                style={[styles.dayNumber, selected && styles.dayTextActive]}
              >
                {date.getDate()}
              </Text>
