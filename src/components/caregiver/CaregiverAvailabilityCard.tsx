...
type CaregiverAvailabilityCardProps = {
  caregiverId: string;
  onChange?: () => void;
};
const DAYS = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];

export function CaregiverAvailabilityCard({
  caregiverId,
  onChange,
}: CaregiverAvailabilityCardProps) {
  ...
  async function loadRows() {
    setRows(await getCaregiverAvailability(caregiverId));
  }
