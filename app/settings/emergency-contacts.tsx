      ...
      rows={[
        {
          ...
          status: "Needed",
          subtitle: "Add a default family emergency contact later.",
        },
        {
          label: "Medical contact",
          subtitle: "Doctor, clinic, or urgent care contact placeholder.",
        },
        {
          label: "Caregiver visibility",
          subtitle: "Control which contacts caregivers can see.",
        },
      ]}
