  ...
  return (
    <AppScreen>
      ...
      <WidgetCard
        ...
        subtitle="These values come from the current device."
      >
        <View style={styles.section}>
          ...
          <SettingsRow
            icon={
              <AppIcon color={colors.status.ai} name="calendar" size={20} />
            }
            label="Calendar"
          ...
          <SettingsRow
            icon={
              <AppIcon color={colors.status.system} name="settings" size={20} />
            }
            label="Clock preference"
            subtitle={
              deviceDefaults.timeFormat === "24_hour"
                ? "24-hour time"
                : "12-hour time"
            }
          />
