...
export const notificationColorTokens: Record<NotificationType, NotificationColorToken> = {
  blue_calendar_activity: {
    accentColor: colors.brand.primary,
    backgroundColor: colors.accent.sky,
    borderColor: "#B7D8FF",
    meaning: "Calendar activity, routines, appointments, and scheduling updates.",
  ...
  green_normal_update: {
    ...
    borderColor: "#B9E9D7",
    meaning: "Normal family or care update that does not need urgent attention.",
  ...
  purple_ai_suggestion: {
    ...
    borderColor: "#D8CCFF",
    meaning: "AI-generated suggestion or summary that should stay clearly labeled.",
